...
class Voetganger {
    constructor(x, y, zRotation, scene) {
        ...
        this.brakeZone = new brakeBlock(this.object, -0.25, 0, 0.5, 0.2, scene);
        this.state = "driving"
        this.maxSpeed = 3
    ...
    createobject() {
        const geometry = new THREE.BoxBufferGeometry(0.2, 0.2, 1);
        geometry.userData.obb = new OBB();
        geometry.userData.obb.halfSize.copy(new THREE.Vector3(0.2, 0.2, 1)).multiplyScalar(0.5);
