...
class Car {
    constructor(x, y, zRotation, scene) {
        ...
        this.brakeZone = new brakeBlock(this.object, -2, 0, 3, 0.1, scene);
        this.state = "driving"
        this.maxSpeed = 8
    ...
    createobject() {
        const geometry = new THREE.BoxBufferGeometry(2.2, 1.2, 0.5);
        geometry.userData.obb = new OBB();
        geometry.userData.obb.halfSize.copy(new THREE.Vector3(2.2, 1.2, 0.5)).multiplyScalar(0.5);
